    ...
    <div class="form-container">
        ...
        <form class="form">
            ...
            <div class="input-group">
                ...
                <input type="text" name="mail" id="umail" placeholder="">
            </div>
            <div class="input-group">
                <label for="password">Senha:</label>
                <input type="password" name="password" id="password" placeholder="">
            </div>
            <button class="sign"><a href="Pag3.html">Entrar</a></button>
        </form>
        <div class="social-message">
            <div class="line"></div>
            <p class="message">Login com as outras redes</p>
            <div class="line"></div>
        </div>
        ...
        <p class="signup">Não tem uma conta?
            <a rel="noopener noreferrer" href="telaLogin.html" class="">Clique aqui!</a>
        </p>
    </div>
    </section>
</body>
